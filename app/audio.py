...
def _check_and_preprocess_next_chapter(current_chapter_id):
    """
...
def stream_chapter(app, chapter_id):
    ...
    try:
        ...
        if current_index == -1:
            ...
            db.session.commit()
            return Response("Chapter not found", status=404)
    ...
    _generation_manager.register_task(user.id, chapter_id, cancel_event)
